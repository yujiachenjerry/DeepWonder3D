...
from .SEG_data_process import test_preprocess_lessMemoryNoTail_SubImgSEG, testset, singlebatch_test_save, multibatch_test_save
...
def seg_3dunet_ffd(net,
    ...
    testloader = DataLoader(test_data, batch_size=opt['batch_size'], shuffle=False, num_workers=4, pin_memory=False)
