...
class calculate_neuron():
    ...
    def get_neuron_mask(self, SEG_dir, RMBG_dir, SR_dir, im_name):
        ...
        mask_stack_filted, mask_stack_max = merge_neuron_SEG_mul_inten(img_SEG1, 
                                        img_RMBG1, 
                                        quit_round_rate = 0.5, 
                                        good_round_rate = 0.8,
        ...
        whole_mask_list = listAdd_remain_trace(whole_mask_list, img_SR, dict_name='remain_sr_trace', mode='update', trace_mode='all')
        # print(whole_mask_list[0].keys())
