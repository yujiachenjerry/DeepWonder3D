...
from .merge_neuron_f import Neuron_List_Initial, list2mask, listAddtrace, centroid_distance, list_union, initial_mask_list
...
def merge_neuron_SEG_mul_inten(mask_stack, 
    ...
    return w_g_neuron_list, w_n_list_init, all_neuron_mask, all_neuron_remain_mask, mask_stack_filted, mask_stack_max
